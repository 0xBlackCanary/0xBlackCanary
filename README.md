...
> *«El canario no canta, detecta.»* 🛡️ Perfil técnico regido por la filosofía del Canary Token: discreción, monitorización perimetral y mitigación activa de riesgos lógicos.
...
#### 🔒 Ciberseguridad & Fortalecimiento
...
- **Automatización & Datos:** Scripts de auditoría nativos en Windows PowerShell, estructuración de bases de datos relacionales, formatos CSV e inyecciones de código HTML5.
- **Gestión Empresarial:** Administración y control de calidad de datos en entornos CRM Zoho y suites avanzadas de Microsoft Office.

---

### 🛸 Certificaciones Aeroespaciales
- **Piloto a Distancia de UAS (AESA / EASA Framework):** Habilitación oficial operativa para la explotación segura de aeronaves no tripuladas en Categoría Abierta (Subcategorías A1/A3). Especialización técnica orientada al análisis de riesgos en el espectro de radiofrecuencia de mando y control y monitorización de zonas geográficas restringidas.
...
### 📈 GitHub Status & Métricas de Red

<p align="left">
  <img src="https://vercel.app" alt="0xBlackCanary Stats" width="48%">
  <img src="https://vercel.app" alt="Top Languages" width="48%">
</p>

---

### 🛰️ Nodos de Conexión Externa
- **Currículum Web:** [0xblackcanary.github.io/cv/](https://github.io)
- **Proyecto Core:** [Canary-USB-Scanner](https://github.com)
